...
FLAC.prototype.getFLACPictures = function() {
    return this._file.getFLACPictures();
};

FLAC.prototype.setFLACPictures = function(tag) {
    return this._file.setFLACPictures(tag);
};
