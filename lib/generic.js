...
GENERIC.prototype.getAll = function() {
    ...
    if (this.getFLACPictures) all.tags.flacPictures = this.getFLACPictures();
    return all;
};
...
GENERIC.prototype.setAll = function(all) {
    ...
    if (all.tags.xiphComment && file.setXiphComment) file.setXiphComment(all.tags.id3v2);
    if (all.tags.flacPictures() && file.setFLACPictures) file.setFLACPictures(all.tags.id3v2);
    return this.getAll();
};
